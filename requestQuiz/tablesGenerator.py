...
try:
    ...
    with open(output_file, "w") as file:
        ...
        for item in data['lvl1']:
            ...
            formatted_content = f"table_add lvl1 lvl1Foward 0x{country_bytes.hex()} => 0x{answer1_bytes.hex()} 0x{answer2_bytes.hex()} 0x{answer3_bytes.hex()} \n"
        ...
        for item in data['lvl2']:
            ...
            formatted_content = f"table_add lvl2 lvl2Foward 0x{country_bytes.hex()} => 0x{answer1_bytes.hex()} 0x{answer2_bytes.hex()} 0x{answer3_bytes.hex()} \n"
            file.write(formatted_content)
        # lvl3
        for item in data['lvl3']:
            ...
            formatted_content = f"table_add lvl3 lvl3Foward 0x{country_bytes.hex()} => 0x{answer1_bytes.hex()} 0x{answer2_bytes.hex()} 0x{answer3_bytes.hex()} \n"
            file.write(formatted_content)
        ...
        for item in data['lvl4']:
            ...
            formatted_content = f"table_add lvl4 lvl4Foward 0x{country_bytes.hex()} => 0x{answer1_bytes.hex()} 0x{answer2_bytes.hex()} 0x{answer3_bytes.hex()} \n"
            file.write(formatted_content)
